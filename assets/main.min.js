...
table=$("#results table");e.sort(sort_stars_by_distance);$.each(e,function(f,g){$.each(g.sts,function(i,h){if(h.has_blackmarket){table.append('<tr class="success"><td>'+g.name+"</td><td>"+h.name+"</td><td>"+($.fn.func=function(){if(h.allegiance==null){return"Unknown";
