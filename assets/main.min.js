...
}else{if(a==b&&d[b]==e){c.push(d);}}}return c;}(function(){function a(b,c,d){if(typeof d==="undefined"||+d===0){return Math[b](c);}c=+c;d=+d;if(isNaN(c)||!(typeof d==="number"&&d%1===0)){return NaN;
